    ...
    >
      ...
      <section className="bg-[#0D2137] text-white pt-12 pb-10 relative border-b border-[#0BB4B0]">
        ...
        <div 
          ...
          style={{
            backgroundImage: "url(\"data:image/svg+xml,%3Csvg width='40' height='40' viewBox='0 0 40 40' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M20 0 L40 20 L20 40 L0 20 Z' fill='none' stroke='%23E0A858' stroke-width='0.5' opacity='0.03'/%3E%3C/svg%3E\")",
        ...
        <div className="relative z-10 px-6">
          <div className="flex justify-between items-center mb-10">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold tracking-tight text-white">نمو</span>
            </div>
          ...
          >
            <motion.h1 variants={fadeUp} className="font-serif text-4xl font-medium leading-[1.4] text-white mb-6">
              كل خطوة تكبر معه.
            </motion.h1>
            
            <motion.p variants={fadeUp} className="text-white/70 text-[15px] leading-relaxed mb-10 font-normal">
              رفيقكِ المتخصص في رحلة طفلكِ مع طيف التوحد. دليلكِ الموثوق للوضوح والهدوء.
            </motion.p>
          </motion.div>
          ...
          >
            <div className="text-center">
              <div className="text-[#E0A858] font-serif font-bold text-2xl mb-1">٥٢</div>
            ...
            <div className="text-center border-r border-[#0BB4B0]/30">
              <div className="text-[#E0A858] font-serif font-bold text-2xl mb-1">٥٩</div>
              <div className="text-white/70 text-[10px] leading-tight">طبيب<br/>موثق</div>
            </div>
            <div className="text-center border-r border-[#0BB4B0]/30">
              <div className="text-[#E0A858] font-serif font-bold text-2xl mb-1">٧</div>
              <div className="text-white/70 text-[10px] leading-tight">مركز<br/>رسمي</div>
            </div>
            <div className="text-center border-r border-[#0BB4B0]/30">
              <div className="text-[#E0A858] font-serif font-bold text-2xl mb-1">٢٤/٧</div>
      ...
      <section className="py-10 px-6 bg-[#FFFFFF]">
        ...
        >
          <motion.h2 variants={fadeUp} className="text-xl font-bold text-[#0D2137] mb-6 flex items-center gap-2">
          ...
          <div className="grid grid-cols-2 gap-3">
            {[
              ...
              <motion.div variants={fadeUp} key={idx} className="border border-[#0D2137]/10 rounded-xl p-4 bg-white relative overflow-hidden group shadow-sm">
      ...
      <section className="py-14 px-6 bg-[#FFF7EE] relative">
        ...
        <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={staggerContainer} className="flex flex-col gap-6 relative z-10 pl-2 pr-6">
          ...
          <motion.div variants={fadeUp} className="bg-white p-5 rounded-2xl shadow-sm border border-[#0D2137]/5 border-r-2 border-r-[#E0A858] relative">
            <Quote className="w-6 h-6 text-[#E0A858]/20 absolute -top-3 -right-2 bg-white px-1" />
            <p className="text-[#0D2137] font-serif italic text-[15px] leading-relaxed mb-3">
              "ترجمة التقارير الطبية بلغة نفهمها سهّلت علينا التواصل مع العائلة والمدرسة."
            </p>
            <p className="text-xs text-[#94A3B8]">— أم من الكويت</p>
          </motion.div>
      ...
      {/* 5. CONTENT-QUALITY TILES SECTION */}
      <section className="py-10 px-6 bg-[#0D2137]/[0.02] border-t border-[#0D2137]/5 text-center">
        <h3 className="text-xs text-[#94A3B8] font-bold mb-6 tracking-wide uppercase">معايير المحتوى</h3>
        <motion.div 
          initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} variants={staggerContainer}
          className="grid grid-cols-2 gap-3 mb-6 text-right"
        >
          <motion.div variants={fadeUp} className="border border-[#0D2137]/10 rounded-lg p-3 bg-white shadow-sm">
          ...
          <motion.div variants={fadeUp} className="border border-[#0D2137]/10 rounded-lg p-3 bg-white shadow-sm">
            ...
            <div className="text-[10px] text-[#475569] leading-relaxed">لا تتم مشاركة بيانات طفلكِ مع أي طرف خارجي.</div>
          </motion.div>
        </motion.div>
      ...
      <section className="bg-[#0D2137] py-12 px-6 text-center text-white relative overflow-hidden flex flex-col items-center">
        ...
        >
          <motion.div variants={fadeUp} className="flex items-center justify-center gap-1 text-[#E0A858] mb-3">
            <Sparkles className="w-3 h-3" />
            <span className="text-xs font-medium">رحلة نمو تبدأ الآن</span>
            <Sparkles className="w-3 h-3" />
          </motion.div>
          
          <motion.h2 variants={fadeUp} className="text-3xl font-bold mb-8 leading-snug">
            ابدئي اليوم.<br/>مجاناً تماماً.
          </motion.h2>
          
          <motion.button variants={fadeUp} className="w-full bg-[#0BB4B0] hover:bg-[#0BB4B0]/90 text-white font-bold py-4 rounded-full flex items-center justify-center gap-2 transition-colors text-lg shadow-lg shadow-[#0BB4B0]/20">
